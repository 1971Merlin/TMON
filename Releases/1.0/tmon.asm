...
; -----------------------------------------------------------------------------
; parameter parser - extracts hex address from command params
;
...
pp:	ld a,(uparaml)
	...
	ret nz			; must be exactly 4 bytes !!!
...
sbuflp:	ld c,RXDATA		; wait for a byte input
	rst 30h
...
banglp:	ld c,RXDATA		; wait for a byte input
	rst 30h
...
outinc:	ld c,SNDMSG		; display the status
	rst 30h
...
tmonver	.db	"TMON Version 1.0",13,10,0
